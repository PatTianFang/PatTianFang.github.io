const photoStories = [
    ...
    {
        title: "夜里的四个人",
        text: "黑夜把背景压得很深，几个人挤在镜头前反而更亮。毕业前的夜晚常常没有特别安排，只是大家还愿意一起多站一会儿。",
        tag: "夜晚"
    },
    {
        title: "窗边的一桌",
        text: "火锅、饮料和靠窗的位置，把聚会拍得很具体。吃饭的时候不一定要说很多，坐在同一张桌子旁就已经很完整。",
        tag: "聚餐"
    },
    {
        title: "山脊上的剪影",
        text: "远处的人站在山脊线上，被天光压成一排剪影。看不清表情也没关系，同行的轮廓已经足够让人想起那天。",
        tag: "山顶"
    },
    {
        title: "再向天空举手",
        text: "同一处山头换了一个动作，队伍像是在对着天光回应。旅行里有些照片会重复，因为那一刻真的值得多留几秒。",
        tag: "剪影"
    },
    {
        title: "水里的冲刺",
        text: "泳帽、泳镜和被划开的水面，让画面一下子紧张起来。大学回忆里也有这种认真用力的瞬间，不只属于轻松玩笑。",
        tag: "游泳"
    },
    {
        title: "困在座位上",
        text: "车上或室内的座位让人很容易放松到睡着。赶路的疲惫被朋友拍下来，后来就成了最真实的旅途注脚。",
        tag: "疲惫"
    },
    {
        title: "摩天轮前",
        text: "黄昏的天空和摩天轮一起出现在身后，几个人站在下面合影。这样的场景带着一点仪式感，也带着出游的轻快。",
        tag: "游乐"
    },
    {
        title: "缆车里的自拍",
        text: "透明车厢把人、城市和窗外的光都装在一起。空间不大，笑脸却很多，像是把一段上升的路也变成合照。",
        tag: "同行"
    },
    {
        title: "车厢里的围坐",
        text: "大家在车厢里靠得很近，镜头从前面把一圈人收住。旅途中的移动空间，也会因为人齐而变得像临时客厅。",
        tag: "车厢"
    },
    {
        title: "草地上躺平",
        text: "几个人直接躺在草地上，把行程和姿势都放松下来。毕业季需要这样的停顿，什么都不做也算一种认真记住。",
        tag: "草地"
    },
    {
        title: "远处的抓拍",
        text: "从高处看见几个人走过，画面有一点旁观者的距离。不是每张照片都要靠近，远远拍下也能留下当天的节奏。",
        tag: "抓拍"
    },
    {
        title: "额头上的玩笑",
        text: "两个圆点贴在额头上，普通自拍立刻变成只有熟人才懂的梗。相册里保留这些奇怪片段，回忆才不会太整齐。",
        tag: "玩笑"
    },
    {
        title: "车厢里的侧脸",
        text: "镜头只拍到车厢里的一角和一个回头的表情。这样的照片像路上随手截下的句子，不完整，却很有现场感。",
        tag: "路上"
    },
    {
        title: "黑白头像",
        text: "黑白色调让一张普通人像突然安静下来。毕业相册里偶尔出现这样的照片，会让热闹之间多一个停顿。",
        tag: "人像"
    },
    {
        title: "海边拱门下",
        text: "站在海边的弧形空间里，身后是远处的光和人群。地点像被框了起来，连普通站立都多了一点纪念感。",
        tag: "海边"
    },
    {
        title: "广场上的同行",
        text: "两个人和孩子一起站在广场上，背景里还有来来往往的人。旅行不是只看风景，也是在不同地方遇见生活。",
        tag: "广场"
    },
    {
        title: "门口的并肩",
        text: "站在门口和栏杆旁的两个人，像是在等下一段安排开始。毕业季由很多这样的间隙组成，简单却很耐看。",
        tag: "门口"
    },
    {
        title: "探出舌头的一秒",
        text: "夸张表情会把拍照这件事从正式里拽出来。多年后再翻到，可能想不起原因，但一定能想起当时的熟悉。",
        tag: "表情"
    },
    {
        title: "楼前再聚齐",
    ...
    {
        title: "新一轮合影",
        text: "又一组照片被放进来，画面里的人、光线和地点让这段回忆继续往后延伸。毕业的故事不是一次整理就结束的。",
        tag: "补记"
    },
    {
        title: "站在风里",
        text: "人站在镜头前，身后的风景慢慢退到远处。这样简单的一张，也能把那天的温度和站立的姿态留下来。",
        tag: "留影"
    },
    {
        title: "靠近一点的朋友",
        text: "镜头把人拉得很近，表情也变得更直接。回看这些照片时，最先被认出的往往不是地点，而是熟悉的脸。",
        tag: "朋友"
    },
    {
        title: "路边的停顿",
        text: "走到一半停下来拍照，背景不一定特别隆重，却很像大学里的很多日常：随手、自然、刚刚好。",
        tag: "路上"
    },
    {
        title: "夏天的边缘",
        text: "画面里有一点明亮，也有一点将要散场的安静。毕业季总是这样，把热闹和不舍放在同一张照片里。",
        tag: "夏天"
    },
    {
        title: "同行的证据",
        text: "照片不只是记录谁到过哪里，也记录谁和谁一起经过。很多年后再看，同行本身就是最清楚的答案。",
        tag: "同行"
    },
    {
        title: "抬头的一瞬",
        text: "一个抬头或转身的瞬间，会比摆好的动作更接近当时。照片留住的不是完美，而是刚好被看见。",
        tag: "瞬间"
    },
    {
        title: "在人群之间",
        text: "热闹的背景让人显得更鲜活。那些嘈杂、走动和临时停下来的几秒，后来都成了相册里的节奏。",
        tag: "人群"
    },
    {
        title: "把笑意放大",
        text: "有些照片一看就知道当时很轻松。笑意不需要解释，它会自己把那天的气氛带回来。",
        tag: "笑意"
    },
    {
        title: "再补一张风景",
        text: "风景照像回忆里的换气口。人暂时不在画面里，但那天经过的天空、建筑和路仍然替故事作证。",
        tag: "风景"
    },
    {
        title: "慢慢走过",
        text: "路被拍下来以后，离开就不只是离开。它变成一条还能被重新看见的线，把那天和现在连在一起。",
        tag: "经过"
    },
    {
        title: "镜头前的停留",
        text: "对着镜头停一下，像是给这段时间按下一个小小的暂停键。下一秒继续往前走，但这一秒已经留下。",
        tag: "停留"
    },
    {
        title: "同框的夏日",
        text: "几个人出现在同一张照片里，夏天就有了具体的形状。光线、衣角和表情都在说明那天没有白过。",
        tag: "同框"
    },
    {
        title: "轻一点的日常",
        text: "不是所有照片都要承担告别的重量。轻松的、随意的、甚至有点模糊的画面，也很像真实生活。",
        tag: "日常"
    },
    {
        title: "远处还亮着",
        text: "远处的光把画面撑开，像是在提醒还有下一段路。毕业回忆里最动人的部分，也许就是这种未完待续。",
        tag: "光"
    },
    {
        title: "把人留在中间",
        text: "构图把人放在画面中间，背景安静地铺开。这样直接的记录，很适合留给多年后的自己辨认。",
        tag: "人像"
    },
    {
        title: "手机里的片段",
        text: "有些照片来自很小的瞬间，像手机里顺手存下的一页。它们不宏大，却能补齐回忆的边角。",
        tag: "片段"
    },
    {
        title: "一起看向镜头",
        text: "一起看向镜头的时候，时间会短暂地排好队。后来再翻到这一张，就知道那一刻大家都在场。",
        tag: "合影"
    },
    {
        title: "被夏天照到",
        text: "光落在身上，画面就有了温度。毕业季的很多情绪，其实都藏在这种不经意的明亮里。",
        tag: "光影"
    },
    {
        title: "小小的确认",
        text: "拍下一张照片，像是在确认这一天真实发生过。地点、人和表情都被收进来，变成可以返回的证据。",
        tag: "确认"
    },
    {
        title: "靠近回忆的边角",
        text: "相册越往后翻，越能看见一些不那么正式的边角。正是这些边角，让整个大学回忆变得更完整。",
        tag: "边角"
    },
    {
        title: "还没散场",
        text: "画面里仍然有停留的意思，像大家只是暂时站在这里，下一秒还会继续说话、继续往前走。",
        tag: "散场前"
    },
    {
        title: "新的名字加入",
        text: "当新的照片和新的名字一起加入，页面也像相册一样长出新的页码。回忆被继续整理，也被继续看见。",
        tag: "新增"
    },
    {
        title: "最后再看一眼",
        text: "这一组补充的末尾，像是把视线再往回拉一次。不是结束，只是给新加入的片段暂时收个尾。",
        tag: "回看"
    },
    {
        title: "留给下一次",
        text: "照片放进页面之后，下一次打开就会更容易回到那天。回忆并不急着说完，它会在每次翻看时继续生长。",
        tag: "下一次"
    },
    {
        title: "又添一页",
        text: "新的照片被接到故事后面，像相册又翻开了一页。那些后来补进来的画面，也属于同一个夏天。",
        tag: "补记"
    },
    {
        title: "安静的补充",
        text: "有些照片不需要很热闹，只要放在那里，就能把一段被遗漏的时间补回来。",
        tag: "安静"
    },
    {
        title: "短短一停",
        text: "走到某处停一下，拍下一张照，然后继续往前。这样的片刻很短，却很适合被留下。",
        tag: "停留"
    },
    {
        title: "小小画面",
        text: "相册里的小图也有自己的重量。它们像旁白，帮那些大合影之外的日常继续说话。",
        tag: "片段"
    },
    {
        title: "光线很轻",
        text: "轻一点的光线落在画面里，回忆也跟着变慢。毕业季不只有告别，也有很多柔和的间隙。",
        tag: "光影"
    },
    {
        title: "把路接上",
        text: "新加入的照片把原本断开的路接起来。再看时，才发现很多地点和表情其实一直互相呼应。",
        tag: "路上"
    },
    {
        title: "朋友在画面里",
        text: "只要朋友出现在画面里，照片就会立刻变得具体。地点可以忘，同行的人很难忘。",
        tag: "朋友"
    },
    {
        title: "远处的背景",
        text: "背景不一定是主角，但它会提醒我们那天在哪里、天气怎样、走过了什么地方。",
        tag: "背景"
    },
    {
        title: "轻松一刻",
        text: "越是不刻意的照片，越容易把当时的松弛感留下。这样的瞬间，是回忆里很珍贵的空白。",
        tag: "日常"
    },
    {
        title: "低声的记录",
        text: "不是每张照片都要大声宣布什么。有些只是低声记录：我们来过，我们一起停过。",
        tag: "记录"
    },
    {
        title: "新名字旁边",
        text: "当新名字加入页面，照片也有了新的入口。人和画面被重新整理到一起，回忆就更完整一点。",
        tag: "人物"
    },
    {
        title: "看见同一段路",
        text: "不同照片看向同一段路，角度变了，心情也变了。拼在一起时，才像真正走过一遍。",
        tag: "同行"
    },
    {
        title: "把时间放慢",
        text: "翻到这里，页面的节奏会慢下来。补充的照片像一段插曲，让告别不那么仓促。",
        tag: "慢看"
    },
    {
        title: "从旧日常里来",
        text: "有些画面来自更早的日常，和毕业那天隔着一段时间。可它们放在一起，仍然属于同一段大学生活。",
        tag: "旧日常"
    },
    {
        title: "一张接一张",
        text: "照片一张接一张地排下去，像在提醒：回忆不是单点，而是很多小事慢慢连成的线。",
        tag: "相册"
    },
    {
        title: "仍然在路上",
        text: "画面里还有向前走的意思。毕业不是停住，而是把这些同行过的路带去下一程。",
        tag: "路上"
    },
    {
        title: "靠近镜头",
        text: "靠近镜头的一刻，表情比风景更重要。多年后再看，最先回来的还是人的样子。",
        tag: "人像"
    },
    {
        title: "晚一点补上",
        text: "有些照片是后来才补上的，但并不晚。只要还记得，就仍然可以被放回属于它的位置。",
        tag: "补上"
    },
    {
        title: "把空缺填满",
        text: "相册总有空缺，补进来的照片让那些空缺变得柔和。它们不改变过去，只让过去更清楚。",
        tag: "完整"
    },
    {
        title: "多一个入口",
        text: "新的人名页和新照片一起出现，像给这段回忆多开了一扇门。以后再找起这些画面，会更容易抵达。",
        tag: "入口"
    },
    {
        title: "还可以继续",
        text: "故事延长到这里，并不是为了收尾。它只是说明这本相册还可以继续长大，还可以继续被翻开。",
        tag: "继续"
    },
    {
        title: "暂时停在这里",
        text: "这一组新增照片先停在这里。下一次再打开时，它们会和前面的画面自然连在一起。",
        tag: "回看"
    }
];
