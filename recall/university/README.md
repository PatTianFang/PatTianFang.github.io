...
当前照片故事共 198 张，每张照片在 `assets/images/`、`assets/webp/story/`、`assets/webp/large/`、`assets/webp/thumbs/` 和 `assets/originals/` 中保持同编号资源。
...
- `方添/`、`谷冰/`、`刘哲豪/`、`彭佳鑫/`、`秦煜杰/`、`张立超/`、`张森/`、`赵龙浩/`：个人二级回忆页，内部有各自独立的图片资源和入口页。
