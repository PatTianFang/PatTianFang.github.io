...
当前照片故事共 173 张，每张照片在 `assets/images/`、`assets/webp/story/`、`assets/webp/large/`、`assets/webp/thumbs/` 和 `assets/originals/` 中保持同编号资源。
...
- `张森/`、`张立超/`、`秦煜杰/`、`方添/`：个人二级回忆页，内部有各自独立的图片资源和入口页。
